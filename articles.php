    ...
    <section class="articles">
        <div class="container">
            ...
            <div style="margin-top: 20px;">
                <h2><a href="#" class="latest-link">মুঠোফোন <span style="font-size: 120%;">&gt;</span></a></h2>
            </div>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">দক্ষিণ কোয়িয়ার প্রযুক্তি জায়ান্ট স্যামসাং, ফোন লঞ্চ করেছে। যার
                                        নাম এস২৪। এটি
                ...
                <div class="col">
                    <div class="card h-100 my-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">স্যামসাং গ্যালাক্সি মুঠোফোনের পরবর্তী সংযোজন</h5>
                            <p class="card-text">
                                দক্ষিণ কোয়িয়ার প্রযুক্তি জায়ান্ট স্যামসাং, ফোন লঞ্চ করেছে। যার নাম এস২৪। এটি তাদের ২০২৪
                                সালের জন্য
                                ফ্ল্যাগশিপ। বলা হচ্ছে
            ...
            <div class="row justify-content-center" style="margin-bottom: 50px;">
                <div class="col-lg-9">
                    <div class="c_title text-center">
                        ...
                        <p class="c_p">সব ধরণের প্রযুক্তির খবর পড়ুন সিলিকনবাইটে<br>প্রযুক্তি জগতের সর্বশেষ খবরে চোখ
                            রাখুন</p>
                    </div>
                </div>
            </div>
