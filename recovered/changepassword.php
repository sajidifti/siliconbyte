            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="c_title text-center">
                        <h1 class="c_h1">Change Password</h1>
                        <p class="c_p ash">Enter The Current and New Passwords</p>
                    </div>
                </div>
            </div>
            <!-- 2nd row-->
                            ...
                            <div class="row g-3 justify-content-center">
                                ...
                                <div class="col-lg-8 col-md-8">
                                    <input type="password" class="form-control c_email"
                                        placeholder="Enter Your Current Password" name="password" required>
                                </div>
                                <div class="col-lg-8 col-md-8">
                                    <input type="password" class="form-control c_email"
                                        placeholder="Enter New Password" name="new-password" required>
                                </div>
                                <div class="col-lg-8 col-md-8">
                                    <input type="password" class="form-control c_email"
                                        placeholder="Confirm New Password" name="confirm-password" required>
                                </div>
                            </div>
                            <div class="row g-3 justify-content-center" style="margin-top: 20px;">
                                <button type="submit" class="btn button-link" name="changeBtn" style="width:fit-content">Change Password</button>
                            </div>
                        </form>
                    </div>
                </div>
