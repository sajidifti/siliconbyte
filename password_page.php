                    ...
                    <div class="c_form">
                        <form method="POST" action="password.php" enctype="multipart/form-data">
                            <div class="row g-3 justify-content-center">
                                ...
                                <div class="col-lg-8 col-md-8">
                                    <input type="password" class="form-control c_email"
                                        placeholder="নতুন পাসওয়ার্ড লিখুন" name="new-password" required>
                                </div>
                                <div class="col-lg-8 col-md-8">
                                    <input type="password" class="form-control c_email"
                            ...
                            <div class="col-lg-4 col-md-4 container-fluid">
                                <button type="submit" class="btn c_button"
                                    style="margin-top: 5rem; width: 100%;">পরিবর্তন এবং সাইনআউট</button>
                            </div>
                        </form>
